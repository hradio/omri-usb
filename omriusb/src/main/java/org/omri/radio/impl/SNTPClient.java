...
public class SNTPClient {
	...
	public interface SntpListener {
		void onTimeReceived(long posixMs);
	 ...
	 */
	SNTPClient(SntpListener listener) {
	...
	public static void getDate(final TimeZone _timeZone, final SntpListener _listener) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				if (sntpClient.requestTime("time.google.com", 5000)) {
					...
					_listener.onTimeReceived(nowAsPerDeviceTimeZone);
				}
