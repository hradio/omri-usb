...
public enum RadioServiceMimeType {
    ...
    RadioServiceMimeType(String contentTypeString, int contentTypeId) {
	...
	public static RadioServiceMimeType fromMimeValue(String mimeValue) {
    	for(RadioServiceMimeType mime : RadioServiceMimeType.values()) {
    		if(mime.contentTypeString.equalsIgnoreCase(mimeValue)) {
    			return mime;
		    }
	    }

    	return RadioServiceMimeType.UNKNOWN;
	}
}
